...
```bash
git remote add encore encore://personal-finance-tracker-v2oi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/personal-finance-tracker-v2oi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/personal-finance-tracker-v2oi/settings/integrations/github)
